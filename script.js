...
tl129.to("#page2next>h1",{
  top:`-50%`
})

var tl139 = gsap.timeline({
  scrollTrigger:{
      trigger:`#page3before`,
      start:`top top`,
      scrub:1,
...
tl139.to("#page3before>h1",{
  top:`-50%`
})

tl139.to("#page3before>h2",{
  top:`-50%`
})
